...
def ProfileInfoView(request):
    ...
    if request.method=="POST":
        ...
        form=ProfileInfoForm(instance=user)
    return render(request,"Account/profile_personal.html",{"form":form})
...
class ProfileOrderView(TemplateView):
    template_name = "Account/profile_order.html"

class ProfileFavoratesView(TemplateView):
    template_name = "Account/profile_favorites.html"

class ProfileAddresView(TemplateView):
    template_name = "Account/profile_address.html"

class ProfileAddresEditView(TemplateView):
    template_name = "Account/profile_addres_edit.html"

class ProfileCommentView(TemplateView):
    template_name = "Account/profile_comment.html"
